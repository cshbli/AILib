...
def int_range(s):
    try:
        ...
        raise argparse.ArgumentTypeError('invalid integer range: ' + s)
...
def main(args):
    ...
    if mps:
        generator = fullsize_sequence(args.dataset, scale=args.scale, subset='valid', downgrade=args.downgrade, image_ids=args.validation_images)
        psnr_dict = {}
        for mp in mps:
...
def parser():
    ...
    parser.add_argument('--validation-images', type=int_range, default='246-259',
